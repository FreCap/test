...
/**
 * Implementazione di una classe che gestisce le coordinate di un punto nello
 * spazio.
 * 
...
public class Coordinates implements ICoordinates, Serializable {
	...
	/**
	 * La precisione dei decimali che si vuole nelle coordinate. Es. con
	 * DECIMAL_PRECISION settata a 6, le coordinate avranno come lunghezza
	 * decimale massima 6 cifre, per + esempio 42.123456
	 */
	...
	/**
	 * Costruttore che prende in ingresso la latitudine e la longitudine di un
	 * punto per crearne le sue coordinate.
	 * 
	 * @param latitude
	...
	/**
	 * Costruttore che prende in ingresso un'altro oggetto di tipo
	 * {@link ICoordinates} per creare un nuovo oggetto posizionato nello stesso
	 * punto dell'oggetto passato.
	 * 
	 * @param coordinates
	 *            Un oggetto {@link ICoordinates} di cui se ne vuole riprodurre
	 *            un altro oggetto Coordinates avente la stessa posizione
	 *            spaziale.
	 */
	...
	/**
	 * Metodo privato utilizzato per troncare i numeri Float fino ad una certa
	 * cifra decimale, stabilita dal campo DECIMAL_PRECISION.
	 * 
	 * @param number
	...
	/*
	 * Due oggetti di tipo coordinata sono ritenuti uguali se hanno stessa
	 * latitudine e longitudine.(non-Javadoc)
	 */
	@Override
	...
	public String toString() {
		return "[Latitude = " + latitude.toString() + ", Longitude = "
				+ longitude.toString() + "]";
	}
