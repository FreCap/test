...
/**
 * Interfaccia per un'avvistamento di un osservatore. La classe che la
 * implementa deve raccogliere tutte le informazioni generate dall'osservatore,
 * quali la data dell' avvistamento, la targa dell'auto avvistata e la sua
 * velocita'.
 * 
...
public interface ISighting {
	...
	/**
	 * Restituisce l'{@link IStreetObserver} che ha generato le informazioni di
	 * questo avvistamento.
	 * 
