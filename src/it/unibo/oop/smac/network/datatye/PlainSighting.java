...
/**
 * Classe di scambio rete client-server, prima di essere tradotto in Sighting
 *
 * Utilizzata poiché non è possibile spedire attraverso la rete un messaggio
 * contentente referenze ad database, quale sarebbe un semplice {@link Sighting}
 * 
 * Implementa la classe Serializable per poter essere serializzata e spedita via
 * rete
 */
public class PlainSighting implements Serializable {
	...
	/**
	 * Restituisce le coordinate dello street observer che effettua
	 * l'avvistamento
	 * 
