...
/**
 * Questa è una classe di utilita', e svolge il compito di costruire e restituire
 * un'immagine contenente una mappa del luogo di cui sono date le coordinate.
 * Le Static Maps restituite vengono prelevate dal servizio di "Open Street Map".
 * La classe e' costruita secondo un pattern Singleton.
 * 
...
public class OSMStaticMapConstructor {
	...
	private static OSMStaticMapConstructor staticMapConstructor = null;
	...
	/**
	 * Metodo che restituisce un'immagine contenente una mappa del luogo di cui sono date
	 * le coordinate. Le Static Maps restituite vengono prelevate dal servizio di "Open 
	 * Street Map".
	 * 
	 * @param lat
	 ...
	 * @return
	 * 			Un'{@link ImageIcon} contenente la mappa del luogo scelto.
	 */
	public ImageIcon getStaticMap(float lat, float lng){
		URL url = OSMURLBuilder.getInstance().buildURL(lat, lng);
		try {
	...
	/**
	 * Classe di utilita': costruisce l'URL necessario per la richiesta della static
	 * map ad "Open Street Map".
	 * La classe e' costruita secondo un pattern Singleton.
	 * 
	 * @author Federico Bellini
	 */
	private static class OSMURLBuilder {
		...
		private static final String OSM_REQUEST_PREFIX =  
		...
		private static OSMURLBuilder instance = null;
