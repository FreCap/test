...
public final class InformationsPanel extends JPanel {
	...
	public InformationsPanel() {
		...
		/*
		 * Inizialmente costruisco un oggetto di InfoStreetObserver che non
		 * contiene nessuna informazione.
		 */
	...
	/**
	 * Metodo di utilita' che restituisce il valore dell'Optional preso come
	 * parametro se e' presente, altrimenti restituisce la stringa
	 * NON_PRESENT_VALUE. Nel caso in cui l'Optional fosse presente e la classe
	 * dell'oggetto in esso contenuto fosse Float, restituisce il Numero Float
	 * in esso contenuto, ma con un numero DECIMAL_PRECISION di cifre
	 * significative.
	 */
	...
	private void showStreetObserverInfo() {
		final String s = new StringBuilder()
				...
				.append(TAB
						+ "Location: "
						+ stringOutputUtility(this.currentInfo
								.getStreetObserverLocation()))
				.append(NEW_LINE)
				.append(TAB + "ID: "
	...
	private void showSpeedInfo() {
		final String s = new StringBuilder()
				...
				.append(NEW_LINE)
				.append(TAB
						+ "Average speed limit (last month): "
