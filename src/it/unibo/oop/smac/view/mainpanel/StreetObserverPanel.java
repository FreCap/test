...
/**
 * Questa classe implementa un JPanel contenente una static map che mostra la
 * posizione dell'osservatore, e un icona verde/rossa a seconda se sta avvenendo
 * un passaggio al di sotto dell'osservatore.
 * 
...
public class StreetObserverPanel extends JPanel {
	...
	/**
	 * Costruttore pubblico della classe. Costruisce un JPanel contenente una
	 * mappa relativa alla posizione dello StreetObserver passato, al quale
	 * attacca il consumer(Observer) passato come secondo argomento.
	 * 
	...
	/**
	 * Mostra un avvenuto passaggio rilevato dall'osservatore cambiando per un
	 * breve tempo l'icona a fianco della static map.
	 */
