...
/**
 * Implementazione dell'interfaccia IView con utilizzo di GUI. Questa classe e'
 * implementata secondo il pattern Observer(metodi attachObservers) ed anche
 * secondo il pattern Facade, facendo da "facciata" per i vari pannelli di cui
 * si compone la GUI.
 * 
...
public class ViewGUI extends JFrame implements IView {
	...
	/**
	 * Questo metodo mostra all'utente che un nuovo {@link IStreetObserver} e'
	 * appena stato connesso.
	 * 
	...
	/**
	 * Questo metodo segnala all'utente che c'e' stato un passaggio sotto
	 * un'osservatore.
	 * 
	 * @param streetObserver
	...
	/**
	 * Questo metodo deve attaccare l'Observer passato come parametro agli
	 * StreetObserver presenti. In questo modo e' l'Observer preso come
	 * paramentro che gestisce il comportamento dell'applicazione quando vengono
	 * fatte delle richieste su degli StreetObserver da parte della View.
	 * 
	 * @param soo
	 *            L'{@link IStreetObserverObserver} da attaccare agli
	 *            StreetObserver presenti nella View.
	 */
	@Override
	 ...
	 * presenti. In questo modo e' l'Observer preso come paramentro che gestisce
	 * il comportamento dell'applicazione quando vengono fatte delle richieste
	 * su delle StolenCars da parte della View.
	 * 
	 * @param sco
	 *            L'{@link IStolenCarsObserver} da attaccare alle StolenCars
	 *            presenti nella View.
	 */
	@Override
