...
/**
 * Implementazione concreta di un {@link MyMapMarker}. Questa implementazione
 * restituisce come immagine per il MapMarker un pin di colore rosso.
...
public class RedMapMarker extends MyMapMarker {
	...
	/**
	 * Restituisce un'immagine contenente il tipo di MapMarker che si vuole
	 * utilizzare. In questo caso e' un pin di colore rosso.
	 * 
