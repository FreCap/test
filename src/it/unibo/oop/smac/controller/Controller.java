...
/**
 * Implementazione del controller dell'applicazione. Tutta l'applicazione e'
 * strutturata secondo il pattern MVC.
 * 
...
public class Controller implements IController {
	 ...
	 * @param sighting
	 *            Oggetto di tipo {@link ISighting} contenente le informazioni
	 *            rilevate dall'osservatore.
	 */
	@Override
	 ...
	 * informazioni sull'{@link IStreetObserver} richiesto. In caso di qualche
	 * malfunzionamento nel model, viene restituito un oggetto della classe
	 * {@link InfoStreetObserver} contenente nessuna informazione.
	 * 
	 * @param streetObserver
