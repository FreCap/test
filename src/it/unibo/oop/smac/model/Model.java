...
/**
 * Implementazione del Model dell'applicazione. Questa classe riceve le
 * richieste di lettura e scrittura di informazioni sugli osservatori. Questa
 * classe e' implementata secondo il pattern Singleton.
 * 
 * @author Federico Bellini
 */
public final class Model extends StreetObserverModelDatabase implements
	...
	public IInfoStreetObserver getStreetObserverInfo(final IStreetObserver streetObserver)
		...
		return new InfoStreetObserver.Builder().streetObserver(streetObserverRow)
				...
				.maxSpeedToday(maxSpeedToday).build();
	}
